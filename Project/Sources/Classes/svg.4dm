...
property _containers:=["a"; "defs"; "g"; "marker"; "mask"; "pattern"; "svg"; "switch"; "symbol"]

// Graphics element that is defined by some combination of straight lines and curves
property _shapes:=["path"; "rect"; "circle"; "ellipse"; "line"; "polyline"; "polygon"]

// Elements that provide additional descriptive information about their parent.
property _descriptive:=["desc"; "metadata"; "title"]

property _notContainer:=["rect"; "line"; "image"; "circle"; "ellipse"; "polygon"; "polyline"; "use"; "textArea"; "path"]

property _aspectRatioValues:=["none"; "xMinYMin"; "xMidYMin"; "xMaxYMin"; "xMinYMid"; "xMidYMid"; "xMaxYMid"; "xMinYMax"; "xMidYMax"; "xMaxYMax"]

property _textRenderingValue:=["auto"; "optimizeSpeed"; "optimizeLegibility"; "geometricPrecision"; "inherit"]

property _reservedNames:=["root"; "latest"; "parent"]
