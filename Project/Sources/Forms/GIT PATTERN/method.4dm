...
Case of 
	...
	: ($event.code=On Load:K2:1)
		...
		_o_button("cancel").setCoordinates(Null:C1517; Null:C1517; _o_button("done").bestSize(Align right:K42:4).coordinates.left-20; Null:C1517).bestSize(Align right:K42:4)
