...
If (This:C1470[""]=Null:C1517)
	...
	$o:=New object:C1471(\
		...
		"edit"; Formula:C1597(_o_menu("edit")); \
		"enable"; Formula:C1597(_o_menu("enable"; Choose:C955(Value type:C1509($1)=Is boolean:K8:9; New object:C1471("enabled"; $1); New object:C1471("item"; $1; "enabled"; $2)))); \
		"delete"; Formula:C1597(_o_menu("delete"; New object:C1471("item"; $1))); \
		"disable"; Formula:C1597(This:C1470.enable(False:C215)); \
		"file"; Formula:C1597(_o_menu("file")); \
		"fonts"; Formula:C1597(_o_menu("fonts"; New object:C1471("style"; $1))); \
		...
		"windows"; Formula:C1597(_o_menu("windows")); \
		"items"; Formula:C1597(_o_menu("items").result)\
		)
